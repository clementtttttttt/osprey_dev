enum PS2_EX2_KEYS{
	PS2_CTRL, PS2_ALT, PS2_TAB
};

const unsigned short _unshifted[100][2] PROGMEM = {
{0x0d, PS2_EX2|PS2_TAB},{0x0e,'`'},{0x11, PS2_EX2|PS2_ALT}, {0x14, PS2_EX2|PS2_CTRL },{0x15,'q'},{0x16,'1'},{0x1a,'z'},{0x1b,'s'},{0x1c,'a'},{0x1d,'w'},{0x1e,'2'},{0x21,'c'},{0x22,'x'},{0x23,'d'},{0x24,'e'},
...
const unsigned short _shifted[100][2] PROGMEM = {
{0x0d, PS2_EX2|PS2_TAB},{0x0e,'`'},{0x11, PS2_EX2|PS2_ALT},{0x14, PS2_EX2|PS2_CTRL},{0x15,'Q'},{0x16,'!'},{0x1a,'Z'},{0x1b,'S'},{0x1c,'A'},{0x1d,'W'},{0x1e,'@'},{0x21,'C'},{0x22,'X'},{0x23,'D'},{0x24,'E'},
